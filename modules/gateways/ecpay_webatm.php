...
function ecpay_webatm_MetaData() {
    return array(
        'DisplayName' => 'ECPay - WebATM',
...
function ecpay_webatm_link($params) {
    ...
    $transaction = new ECPay_Pay('WebATM');
    ...
    $transaction->ReturnURL = $systemurl.'/modules/gateways/callback/ecpay_webatm.php';
