...
class ECPay_Pay
{
	...
	private $posturl = 'https://payment.ecpay.com.tw/Cashier/AioCheckOut/V5';
	public  $HashIV;
	public  $HashKey;
	...
	{
		$this->posturl = 'https://payment-stage.ecpay.com.tw/Cashier/AioCheckOut/V5';
	...
	function GetHTML($btnText='Pay Now', $btnStyle='') {
		...
		$form .= '<input type="submit" style="'.$btnStyle.'" class="btn btn-success btn-sm" value="'.$btnText.'"></form>';
		return $form;
	}
}
...
class ECPay_Credit
{
	...
	private function Sent()
	{
		...
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'https://payment.ecpay.com.tw/CreditDetail/DoAction');
